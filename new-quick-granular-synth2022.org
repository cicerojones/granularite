...
#+RESULTS:
: #<synth-node[loading]: granularite.cf44/audition-synth 49>
...
*** overview note
Work through the above example quickly and remember it.
...
1. lower the dur-numerator to be "snippet"
2. create a medium fast t-rate
